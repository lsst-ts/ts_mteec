...
setuptools.setup(
    name="ts_mteec",
    description="Interface to control the MTEEC system.",
    use_scm_version={
        "write_to": "python/lsst/ts/mteec/version.py",
    ...
    data_files=[(os.path.join(data_files_path, "schema"), ["schema/mteec.yaml"])],
    scripts=["bin/run_mteec.py"],
    tests_require=tests_require,
    extras_require={"dev": dev_requires},
    license="GPL",
    project_urls={
        "Bug Tracker": "https://jira.lsstcorp.org/secure/Dashboard.jspa",
        "Source Code": "https://github.com/lsst-ts/ts_mteec",
    },
)
